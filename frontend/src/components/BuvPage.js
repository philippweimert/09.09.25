    ...
    <div className="min-h-screen bg-acencia">
      ...
      <section className="bg-acencia py-16 md:py-20">
        <style dangerouslySetInnerHTML={{ __html: `
          .coming-soon-card, .benefit-card, .statistics-card {
          ...
          .coming-soon-card::before, .benefit-card::before, .statistics-card::before {
            content: '';
            position: absolute;
            top: 0;
            left: -100%;
          ...
          .coming-soon-card:hover::before, .benefit-card:hover::before, .statistics-card:hover::before {
            left: 100%;
          }

          .coming-soon-card:hover, .benefit-card:hover, .statistics-card:hover {
          ...
          .coming-soon-label, .benefit-label, .statistics-label {
          ...
          .coming-soon-label, .statistics-label {
            font-size: 1.25rem;
          }
